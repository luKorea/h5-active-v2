 ...
 * @LastEditTime: 2022-07-19 10:13:05
...
export default {
  ...
  data() {
    return {
      headerImg: BASE_IMAGE_SUMMARY_URL + "/even-bg.png",
      programBtn: BASE_IMAGE_SUMMARY_URL + "/even-program.png",
      redBookBtn: BASE_IMAGE_SUMMARY_URL + "/even-redbook.png",
    };
  },
